...
struct DoublingBeer //The amount of drinks and then the extra drinks
{
    ...
    {
        std::cout << "    Multiplying " << a << " beer " << " by " << b << " water" << std::endl;
        return a*b;
    }
};
...
void BindMixer::bindTasks()
{
    ...
    std::cout << "    Calling \"Inbetween\" function and getting result: " << Inbetween(boundAddDrinks, water, beer) << " liters of beer and water" << std::endl; //bind combine drinks here too
    ...
    std::cout << "    Calling add drinks and getting result: " << boundAddDrinks(beer, water) << " liters of beer and water" << std::endl;
    ...
    std::cout << boundRemoveWater(beer, water) << " liters... wow, negative amount is kinda against the laws of physics" << std::endl;
