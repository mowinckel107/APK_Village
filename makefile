SOURCES= main.cpp Smith.cpp MetalBar.cpp Marketplace.cpp BasicBakery.cpp StrongBakery.cpp BakerKing.cpp Dough.cpp Oven.cpp TimeOfDay.cpp TownCrier.cpp innkeeper.cpp tavern.cpp bindMixer.cpp functionAssistant.cpp Bank/PoorPerson.cpp Bank/MiddelClassPerson.cpp Bank/RichPerson.cpp Bank/Bank.cpp Cook.cpp Hunter.cpp
DIRECTORIES = Bank
