SOURCES=main.cpp Smith.cpp Marketplace.cpp MetalBar.cpp BasicBakery.cpp StrongBakery.cpp Bread.cpp BakerKing.cpp boostTavernUtils.cpp innkeeper.cpp tavern.cpp
